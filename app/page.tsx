          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="retro-card group flex flex-col h-full min-h-0">
                ...
                <h3 className="text-lg sm:text-xl font-retro text-neon-pink mb-3 flex-shrink-0 break-words">{interest.title}</h3>
          ...
          <div className="retro-card mb-12 border-neon-pink/30">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="border-2 border-neon-cyan/30 p-4 hover:border-neon-pink hover:neon-glow-pink transition-colors flex flex-col items-center gap-2 group"
              >
                <svg className="w-8 h-8 text-neon-cyan group-hover:text-neon-pink transition-colors" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-sm text-neon-cyan group-hover:text-neon-pink transition-colors font-mono">GitHub</span>
              </a>
              ...
              >
                ...
                <span className="text-sm text-neon-cyan group-hover:text-neon-pink transition-colors font-mono">Scholar</span>
              </a>
              ...
              >
                ...
                <span className="text-sm text-neon-cyan group-hover:text-neon-pink transition-colors font-mono">LinkedIn</span>
              </a>
              ...
              >
                ...
                <span className="text-sm text-neon-cyan group-hover:text-neon-pink transition-colors font-mono">ORCID</span>
              </a>
            </div>
